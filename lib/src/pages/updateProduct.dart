...
class _UpdateProduct extends State<UpdateProduct> {
        ...
        child: new Theme(
          ...
          child: new TextFormField(
            ...
            decoration: new InputDecoration(
                ...
                prefixIcon:
                    const Icon(Icons.local_mall, color: Color.fromRGBO(20, 116, 227, 1)),
                prefixText: ' ',
                suffixStyle: const TextStyle(color: Colors.green)),
          ),
        ),
        ...
        child: new Theme(
          ...
          child: new TextFormField(
            ...
            decoration: new InputDecoration(
                ...
                labelText: 'Precio',
                prefixIcon:
                    const Icon(Icons.monetization_on, color: Color.fromRGBO(20, 116, 227, 1)),
                suffixStyle: const TextStyle(color: Colors.green)),
            validator: (value) {
        ...
        child: Padding(
            ...
            child: Padding(
              ...
              child: Center(
                child: Row(
                  children: <Widget>[
                    Icon(Icons.keyboard_arrow_down, color: Color.fromRGBO(20, 116, 227, 1)),
                    SizedBox(
                      width: 20.0,
                    ),
                    Expanded(
      ...
      child: Row(
        ...
        children: <Widget>[
          GestureDetector(
            ...
            child: Container(width: 100, height: 120, child: _showImage1()),
          ),
          GestureDetector(
            onTap: () {
              _selectphoto2();
  ...
  Widget _alert(BuildContext context) {
    showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            title: Text('Producto Publicado satisfactoriamente '),
            content: Text(
                'ahora tu producto esta activo pero lo podras inactivar o editar. en caso de que alguien este interesado en el se te notificara.'),
            actions: <Widget>[
              FlatButton(
                  onPressed: () {
